...
namespace FurnitureStore.DataAccess.Migrations
{
    ...
    [Migration("20240404144711_AddTotalPriceForCartItem")]
    partial class AddTotalPriceForCartItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FurnitureStore.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FurnitureStore.Models.CartItem", b =>
                {
                    b.HasOne("FurnitureStore.Models.ShoppingCart", "ShoppingCart")
                        .WithMany("CartItems")
