...
namespace FurnitureStore.DataAccess.Migrations
{
    ...
    [Migration("20240402221149_RemoveCustomersDiscount")]
    partial class RemoveCustomersDiscount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FurnitureStore.Models.CustomerDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomersDiscount");
                });

            modelBuilder.Entity("FurnitureStore.Models.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FurnitureStore.Models.CustomerUser", b =>
                {
            ...
            modelBuilder.Entity("FurnitureStore.Models.CustomerDiscount", b =>
                {
                    b.HasOne("FurnitureStore.Models.CustomerUser", "CustomerUser")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FurnitureStore.Models.Discount", "Discount")
                        .WithMany()
