...
namespace FurnitureStoreWeb.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //if email contains admin you are assigned admin role
                    await _userManager.AddToRoleAsync(user, user.Email.ToLower().Contains("admin") ? Roles.Admin : Roles.Customer);
